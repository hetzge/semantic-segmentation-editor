...
export default class SseCameraToolbar extends SseToolbar {
  ...
  componentDidMount() {
    ...
    this.onMsg("color-boost-toggle", () => {
      ...
      this.setState({
        colorBoostVisible: this.state.colorBoostVisible == "none" ? "" : "none",
      });
    });
    this.onMsg("point-size-toggle", () => {
      ...
      this.setState({ colorBoostVisible: "none" });
      this.setState({
        pointSizeVisible: this.state.pointSizeVisible == "none" ? "" : "none",
      });
    });
  }
  ...
  render() {
    ...
    const pointSizeSliderStyle = {
      display: this.state.pointSizeVisible,
      height: "150px",
      position: "absolute",
      left: "-30px",
      top: "-110px",
