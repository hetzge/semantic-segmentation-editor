    ...
    return (
      <div className="display-none">
        <div id="polygonCommandHelp">
          <p>
            <strong>Polygon Drawing Tool</strong>
          </p>
          <p className="italic">Click and/or drag to create points</p>
          <p>Type ESC to remove last created points in reverse order</p>
          <p>
            Drag the mouse pointer or hold Shift to create a complex polygon
            without having to click for each point
          </p>
          <p>Type ENTER or double click the first point to close the polygon</p>
        </div>
        <div id="magicCommandHelp">
          <p>
            <strong>Magic Tool</strong>
          </p>
          <p className="italic">
            Create a polygon automatically using contrast threshold detection{" "}
          </p>
          <p>
            This tool is only useful to draw the outline of objects that have
            sharp contrasted edges (examples: sky, lane marking)
          </p>
          <p>
            Click inside the area you want to outline, then adjusts any sliders
            on the right to adjust the result
          </p>
        ...
        <div id="pointerCommandHelp">
          <p>
            <strong>Manipulation Tool</strong>
          </p>
          <p className="italic">
          ...
          <p>
            Click the line of a polygon to create a new point and drag the newly
            created point to place it
          </p>
        </div>
        <div id="cutCommandHelp">
          <p>
            <strong>Cutting/Expanding Tool</strong>
          </p>
          ...
          <p>
            The new line replace the existing path between starting and ending
            points
          </p>
        ...
        <div id="followCommandHelp">
          <p>
            <strong>Contiguous Polygon Tool</strong>
          </p>
          <p className="italic">Create contiguous polygons easily</p>
          <p>Start a new polygon with the Polygon Drawing Tool</p>
          <p>
            Create the starting point by snapping to the outline of the polygon
            you want to workaround
          </p>
          <p>
            Create the ending point by snapping to another outline, at this
            point you must have a straight line crossing one or more existing
            polygons
          </p>
          <p>
