    ...
    return (
      <div className="sse-sliders vflex">
        <div className="section">
          ...
          <button
            className="sse-button w100"
            onClick={() => this.sendMsg("reset-start")}
          >
            Reset Segmentation
          </button>
        </div>
        <div className="grow">
          <div
            className={this.state.visiblePanel == "flood" ? "" : "display-none"}
          >
            <SseFloodPanel />
          </div>
        </div>
        <div className="section">
          ...
          <div className="hflex">
            <button
              className="sse-button grow"
              onClick={() => this.resetFilters()}
            >
              Reset
            </button>
            <button
              className="sse-button grow ml3"
